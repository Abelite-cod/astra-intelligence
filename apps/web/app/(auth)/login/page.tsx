...
function LoginForm() {
  ...
  return (
    <div className="w-full max-w-sm">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl font-semibold text-[#F5F2EE] tracking-tight">Sign in</h1>
        <p className="mt-1.5 text-sm text-[#928C83]">Enter your credentials to continue</p>
      </div>
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-xs text-[#524D47] hover:text-[#928C83] transition-colors"
            >
              Forgot password?
            </Link>
          </div>
      ...
      {/* Footer */}
      <p className="mt-6 text-center text-sm text-[#6E6860]">
        ...
        <Suspense
          fallback={
            <div className="w-full max-w-sm space-y-4 animate-pulse">
              <div className="h-6 bg-[#161310] rounded-sm w-1/3" />
              <div className="h-4 bg-[#161310] rounded-sm w-1/2" />
              <div className="h-10 bg-[#161310] rounded-sm" />
              <div className="h-10 bg-[#161310] rounded-sm" />
              <div className="h-10 bg-[#161310] rounded-sm" />
            </div>
          }
